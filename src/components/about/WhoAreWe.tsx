    ...
    <div className="font-sans">
      ...
      <section className="max-w-6xl mx-auto py-16 px-4 md:px-8">
        ...
        <p className="text-center max-w-4xl mx-auto text-gray-700 leading-relaxed">
          <span className="font-bold">Franchise Media</span>, is the first
          franchise business provider & consultant in Kerala, which is working
          across several industries, 100 plus brands to bring out the best
          franchise opportunities for all the business enthusiasts out there.
          From the establishing year 2016, The company offered the structure to
          grow, develop, expand, and flourish the business models of the
          franchise industries. From franchise strategic planning to franchise
          marketing, our dedicated team is equipped with extensive resources to
          offer the expertise, guidance, and support necessary to expand a brand
          via the franchise distribution model.
        </p>
